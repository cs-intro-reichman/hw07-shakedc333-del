...
public class Binomial {
	...
	public static long binomial(int n, int k) { //// This function creates a 2D array, say memo, and then initializes
												/// all its elements to -1. It then calls binomial(n, k, memo), which
												/// does all the heavy lifiting.
		// Create memo table and initialize to -1
